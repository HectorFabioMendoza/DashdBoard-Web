...
## Completadas
- [x] **Subida y sincronización a GitHub de Tablero Inventario Carapacho y Dashboard Web** — Codex, 2026-07-23. Sincronizado exitosamente en GitHub (`HectorFabioMendoza/DashdBoard-Web`), incluyendo extractor Python, 22 Grupos GA oficiales (GA01 al GA22), prioridad enmascarada `#1..#N`, UX invertida de filtrado por grupos, paginación a 25 ítems por defecto y compilación `/dist/`.
